...
mycursor.execute(
"CREATE TABLE STUDENT (STUDENT_ID INTEGER , NAME TEXT, EMAIL TEXT, PHONE_NO TEXT, GENDER TEXT, DOB TEXT, STREAM TEXT)"
)
...
def remove_record():
   if not tree.selection():
       ...
       mycursor.execute('DELETE FROM SCHOOL_MANAGEMENT WHERE STUDENT_ID=%d' % selection[0])
       mycursor.commit()
